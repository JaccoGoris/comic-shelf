...
export class ComicsService {
  ...
  async update(id: number, dto: UpdateComicDto) {
    ...
    if (dto.legacyNumber !== undefined) scalarData.legacyNumber = dto.legacyNumber;
    if (dto.variantNumber !== undefined) scalarData.variantNumber = dto.variantNumber;
    ...
    if (dto.numberOfPages !== undefined) scalarData.numberOfPages = dto.numberOfPages;
    if (dto.printing !== undefined) scalarData.printing = dto.printing;
    if (dto.coverPriceCents !== undefined) scalarData.coverPriceCents = dto.coverPriceCents;
    if (dto.coverPriceCurrency !== undefined) scalarData.coverPriceCurrency = dto.coverPriceCurrency;
    ...
    if (dto.storageLocation !== undefined) scalarData.storageLocation = dto.storageLocation;
    if (dto.loanedTo !== undefined) scalarData.loanedTo = dto.loanedTo;
    if (dto.signedBy !== undefined) scalarData.signedBy = dto.signedBy;
    if (dto.personalRating !== undefined) scalarData.personalRating = dto.personalRating;
    if (dto.purchasePriceCents !== undefined) scalarData.purchasePriceCents = dto.purchasePriceCents;
    if (dto.purchasePriceCurrency !== undefined) scalarData.purchasePriceCurrency = dto.purchasePriceCurrency;
    if (dto.purchaseDate !== undefined) scalarData.purchaseDate = dto.purchaseDate ? new Date(dto.purchaseDate) : null;
    if (dto.purchasedFrom !== undefined) scalarData.purchasedFrom = dto.purchasedFrom;
    if (dto.collectionWishlist !== undefined) scalarData.collectionWishlist = dto.collectionWishlist;
    if (dto.notes !== undefined) scalarData.notes = dto.notes;
    if (dto.gradedBy !== undefined) scalarData.gradedBy = dto.gradedBy;
    if (dto.gradedRating !== undefined) scalarData.gradedRating = dto.gradedRating;
    if (dto.gradedLabelType !== undefined) scalarData.gradedLabelType = dto.gradedLabelType;
    if (dto.gradedSerialNumber !== undefined) scalarData.gradedSerialNumber = dto.gradedSerialNumber;
